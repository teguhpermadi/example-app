                ...
                <div class="col-sm-9">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td>Kelurahan</td>
                                <td><input type="text" name="kelurahan"id=""  class="form-control" ></td>
                            </tr>
                            <tr>
                                <td>Kecamatan</td>
                                <td><input type="text" name="kecamatan"id=""  class="form-control" ></td>
                            </tr>
                            <tr>
                                <td>Distrik</td>
                            ...
                            <tr>
                                <td>Provinsi</td>
                                <td><input type="text" name="provinsi"id=""  class="form-control"></td>
                            </tr>
                            <tr>
                                <td>Kodepos</td>
