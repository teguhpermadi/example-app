    ...
    <form wire:submit.prevent="submit">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" wire:model='lat' id="lat" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <input type="text" wire:model="long" id="long" class="form-control">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('livewire:load', () => {
        const defaultLocation = [106.82720484228992, -6.175246893337061]
        ...
        map.on('click', (e) => {
            ...
            $('#lat').val(lattitude)
            add_marker(e)
            Livewire.emit('locations', {long : longtitude, lat : lattitude})
        })
